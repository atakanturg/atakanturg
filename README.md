...
### Current Development
* **LIF Neuron Simulation:** Modeling neuronal membrane logic using **MATLAB** and **Python**. Essentially a really basic Leaky Integrate-and-Fire (LIF) models to better understand how neuromorphic hardware would work.
* **Open-Source Stock Rover:** Building a zero-cost stock funneling tool designed for my liking and anyone else who wants to use it. Stock funelling based on spedcific criteria seems to be a feature that is usually behind a paywall.
